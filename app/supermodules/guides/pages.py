...
MODULE_EMOJI = os.path.join(os.path.dirname(__file__).rsplit('supermodules', 1)[0], 'pages_legacy', '10_📚_Guides.py')
...
try:
    ...
    import streamlit as st
    st.exception(f"Fallo al cargar la página 10_Guides.py: {e}")
