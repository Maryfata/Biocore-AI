...
MODULE_EMOJI = os.path.join(os.path.dirname(__file__).rsplit('supermodules', 1)[0], 'pages_legacy', '9_🦾_EMG_Muscle_Lab.py')
...
try:
    ...
    import streamlit as st
    st.exception(f"Fallo al cargar la página 9_EMG_Muscle_Lab.py: {e}")
