...
MODULE_EMOJI = os.path.join(os.path.dirname(__file__).rsplit('supermodules', 1)[0], 'pages_legacy', '8_🧠_EEG-Neuro-Lab.py')
...
try:
    ...
    import streamlit as st
    st.exception(f"Fallo al cargar la página 8_EEG_Neuro_Lab.py: {e}")
